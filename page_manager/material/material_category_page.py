...
class MaterialCategoryPage(BasePage):
    ...
    def create_material_category(self):
        ...
        if self.visibility_el(('xpath', "//div[@class='MuiBox-root css-rgvlf8']//h6")):
        ...
        elif self.visibility_el(('xpath', "//div[text()='999999']")):
            self.driver.find_element('xpath', "//button[text()='新增一级分类']").click()
    ...
    def update_category(self):
        ...
        self.driver.find_element("xpath", '(//button[@class="MuiButtonBase-root '
